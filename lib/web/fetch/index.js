...
function fetch (input, init = {}) {
  ...
  publishFetchRequest(request)

  p.promise
    .then(response => { publishFetchResponse(request, response) })
    .catch((error) => { publishFetchRequestError(request, error) })
...
function abortFetch (p, request, responseObject, error) {
  publishFetchAbort(request, error)
...
function httpRedirectFetch (fetchParams, response) {
  ...
  publishFetchRequestRedirect(fetchParams.request)
